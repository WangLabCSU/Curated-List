...
整理我的浏览器收藏夹，太多年了～！放在这里的目的是为了方便整理和查找，针对团队成员的一些学习和培养，有专门整理的一些初步资料方便最基础入门（当然不是说这里整理的是高深的东西）。
...
- [ML_DL_LearningList](https://github.com/Simon32/ML_DL_LearningList)
...
- [numpy 实现的 周志华《机器学习》书中的算法及其他一些传统机器学习算法](https://github.com/fengyang95/tiny_ml)
...
- [DeepLearningBook读书笔记](https://discoverml.github.io/simplified-deeplearning/)
- [Awesome ChatGPT Prompts](https://github.com/f/awesome-chatgpt-prompts)
- [Deeplearning with PyTorch](https://github.com/deep-learning-with-pytorch/dlwpt-code)
- [Programming PyTorch for Deep Learning](https://github.com/falloutdurham/beginners-pytorch-deep-learning)
- [OpenAI CookBook](https://cookbook.openai.com/)
- [The fast.ai course notebooks](https://github.com/fastai/course22)
...
- [luminal - Deep learning at the speed of light](https://github.com/luminal-ai/luminal)
...
- [tinygrad: For something between PyTorch and karpathy/micrograd](https://github.com/tinygrad/tinygrad)
- [DoubleML provide an implementation of the double / debiased machine learning framework](https://docs.doubleml.org/stable/index.html)
- [torchdrug - A powerful and flexible machine learning platform for drug discovery](https://github.com/DeepGraphLearning/torchdrug)
...
- [GenAI - Generative Artificial Intelligence Toolbox](https://genai.gd.edu.kg/)

## Blogs/List

- [Python Resources for Everybody](https://learnbyexample.github.io/py_resources/)
- [A study guide to learn about Graph Neural Networks (GNNs)](https://github.com/dair-ai/GNNs-Recipe)
- [The Incredible PyTorch: a curated list of tutorials, papers, projects, communities and more relating to PyTorch](https://github.com/ritchieng/the-incredible-pytorch?tab=readme-ov-file)
- [深度学习优化入门：Momentum、RMSProp 和 Adam](https://mp.weixin.qq.com/s/33z1Hyz_8NAJHEGY6JXxWQ)
- [人工智能术语表](https://jiqizhixin.gitbook.io/artificial-intelligence-terminology-database/)
- [PyTorch implementations of Generative Adversarial Networks](https://github.com/eriklindernoren/PyTorch-GAN)
- [Algorithms for Competitive Programming](https://cp-algorithms.com/)
- [JupyterLab Unofficial Extensions & Tools](https://jupyterlab-contrib.github.io/extensions.html)
...
- [DeepSeek-R1 \ Kimi 1.5 及类强推理模型开发解读](https://www.bilibili.com/video/BV1DJwRevE6d/?buvid=XY4D2B84A824BCB56DA238959C4259253E8EF&from_spmid=dt.video-dt.video.0&is_story_h5=false&mid=oOTiJHx3XF%2BmLCYYVnfcpw%3D%3D&plat_id=114&share_from=ugc&share_medium=android&share_plat=android&share_session_id=3d124e97-0d4c-4ef6-ae94-e1e315d06b8a&share_source=WEIXIN_MONMENT&share_tag=s_i&spmid=united.player-video-detail.0.0&timestamp=1739781062&unique_k=rSjumUw&up_id=3493095748405551&wxfid=o7omF0YO0eS7jjqkKC76iEOR4ajc&share_times=2&_unique_id_=ef014b7d-d183-417c-aa06-56badaeab198&code=0415fb0003XLJT1cwG300C986w35fb0b&state=&vd_source=295fe87a6b67e73540bc390bf01d423e)
- [Deep Dive into LLMs like ChatGPT](https://www.youtube.com/watch?v=7xTGNNLPyMI)
- [My 4-steps to learn deep learning for genomics](https://divingintogeneticsandgenomics.com/post/how-i-am-learning-deep-learning/)
